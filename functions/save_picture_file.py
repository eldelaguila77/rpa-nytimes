...
class SavePictureFile(Utils):
    def create_images_directory(self, output_path: str) -> None:
        """
    ...
    def save_picture(self, image_uri: str, filename: str) -> None:
        """
        ...
        #Process
        self.create_images_directory(export_path) 
        if image_uri != "N/A":
    ...
    def export_to_zip(self) -> None:
        ...
        """
        img_directory = self.path_to_save_files()
