...
def get_global_variables(global_variable: str) -> str:
    """
...
def search_term_count_by_new(txt: str, search_term: str) -> int:
    """
...
def find_money_in_text(text: str) -> str:
    """
